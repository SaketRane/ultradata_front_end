...
const NetExpensesReinsuranceTable: React.FC = () => {
  const rows: RowDefinition[] = [
    ...
    { name: "Total net expenses from Reinsurance contracts held corresponding with Insurance contracts issued", rowCode: "599", indent: 0, isTotal: true },
    { name: "Total net expenses from Reinsurance contracts held corresponding with Reinsurance contracts issued", rowCode: "699", indent: 0, isTotal: false },
