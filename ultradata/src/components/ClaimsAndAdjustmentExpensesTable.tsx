...
const columnCodes = [
  ...
  {
    label:
      'Net provision for portfolio acquisition/ disposition at transaction date',
    code: '11',
  },
  {
    label: 'Net amount paid during the year for claims of prior years',
    code: '10',
  },
...
const tableRows = [
  ...
  {
    name: '- Personal excluding Home and Product Warranty',
    indent: 1,
    rowCode: '03',
    isSubtotal: false,
    isTotal: false,
  ...
  {
    name: 'Subtotal - Private Passenger',
    indent: 1,
    rowCode: '14',
    isSubtotal: true,
    isTotal: false,
  ...
  {
    name: 'Other than Private Passenger',
    indent: 1,
    rowCode: '',
    isSubtotal: false,
    isTotal: false,
  ...
  {
    name: 'Subtotal - Other than Private Passenger',
    indent: 1,
    rowCode: '18',
    isSubtotal: true,
    isTotal: false,
  ...
  {
    name: 'Facility Assoc. Residual Market',
    indent: 1,
    rowCode: '',
    isSubtotal: false,
    isTotal: false,
  ...
  {
    name: 'Subtotal - Facility Assoc. Residual Market',
    indent: 1,
    rowCode: '25',
    isSubtotal: true,
    isTotal: false,
  ...
  {
    name: 'Boiler and Machinery excluding Equipment Warranty',
    indent: 0,
    rowCode: '32',
    isSubtotal: false,
    isTotal: false,
  ...
  {
    name: '- Comprehensive General Liability (with products)',
    indent: 1,
    rowCode: '50',
    isSubtotal: false,
    isTotal: false,
  ...
  {
    name: '- Comprehensive General Liability (without products)',
    indent: 1,
    rowCode: '51',
    isSubtotal: false,
    isTotal: false,
  ...
  {
    name: 'Out of Canada Liabilities',
    indent: 0,
    rowCode: '80',
    isSubtotal: false,
    isTotal: false,
      ...
      <Table className="min-w-[1200px] text-xs dropdown-data">
        <TableHeader className="sticky top-0 bg-white/95 backdrop-blur-sm z-10">
          <TableRow>
            ...
            <TableHead
              colSpan={4}
              className="text-xs font-semibold text-center py-2 px-4 border-r border-b"
            >
            ...
            <TableHead
              ...
              className="text-xs font-semibold text-center py-2 px-4 border-r border-b"
            >
              Provision for unpaid claims (including unreported) and adjustment
              expenses - current year
            </TableHead>
            <TableHead
              colSpan={6}
              className="text-xs font-semibold text-center py-2 px-4 border-b"
            >
        ...
        <TableBody className="text-[10px]">
          {tableRows.map((row, index) => {
            ...
            const paddingClass =
              row.indent === 0 ? '' : row.indent === 1 ? 'pl-8' : 'pl-16';
