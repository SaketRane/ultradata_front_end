...
const PremiumsEarnedTable: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    tableRows.forEach((row) => {
      Object.entries(provinceCodes).forEach(([province, provinceCode]) => {
        arrayOfCellCode.push(generateDataCode(row.rowCode, provinceCode));
      });
    });
    handleBatchCode(arrayOfCellCode);
  }, [tableRows, provinceCodes]);
...
export default PremiumsEarnedTable;
