...
const SummaryOfInvestmentsTable2015: React.FC = () => {
  const rows: RowDefinition[] = [
    ...
    {
      name: 'Municipal, Public Authority, Schools',
      rowCode: '',
      indent: 0,
      isHeader: true,
    },
    ...
    {
      name: 'Total Bonds and Debentures',
      rowCode: '199',
      indent: 0,
      isTotal: true,
    },
    ...
    {
      name: 'Largest Exposure to an Entity or Connected Group',
      rowCode: '610',
      indent: 1,
      isTotal: false,
    },
    {
      name: '2nd Largest Exposure to an Entity or Connected Group',
      rowCode: '620',
      indent: 1,
      isTotal: false,
    },
    {
      name: 'Largest Pooled Holding',
      rowCode: '630',
      indent: 1,
      isTotal: false,
    },
    {
      name: '2nd Largest Pooled Holding',
      rowCode: '640',
      indent: 1,
      isTotal: false,
    },
  ...
  const columns: ColumnDefinition[] = [
    {
      id: 'fvtpl',
      label: 'Fair Value Through Profit or Loss (FVTPL)',
      colCode: '05',
    },
    {
      id: 'fvoci',
    ...
    {
      id: 'balanceSheetValue',
      label: 'Balance Sheet Value Col.',
      colCode: '35',
    },
    ...
    {
      id: 'impairedAmount',
      label: 'Impaired Amount (Before Provisions)',
      colCode: '60',
    },
    { id: 'marketValue', label: 'Market Value of Column (30)', colCode: '65' },
    {
      id: 'indexLinkedProducts',
      label: 'Balance Sheet Value of Assets Used to Back Index Linked Products',
      colCode: '70',
    },
  ];
  ...
  const secondaryHeader = (
    <tr className="h-6 border-b">
      ...
      <th
        className="text-xs font-semibold text-center py-0 px-1 border-r"
        colSpan={6}
      ></th>
      <th
        className="text-xs font-semibold text-center py-0 px-1 border-r bg-blue-50"
        colSpan={4}
      >
