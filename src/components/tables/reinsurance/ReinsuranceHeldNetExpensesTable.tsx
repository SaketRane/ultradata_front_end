 ...
 * Displays detailed breakdown of reinsurance expenses and assets
 */
const ReinsuranceHeldNetExpensesTable: React.FC = () => {
  ...
  // Define column data for all the different categories
  const columns: ColumnDefinition[] = useMemo(() => [
    ...
    { id: "underPAA", label: "Under PAA", colCode: "72" },
    { id: "notUnderPAA", label: "Not under PAA", colCode: "74" },
  ...
  // Secondary header for the table showing main category divisions
