...
const InsuranceServiceResultProvincialTable: React.FC = () => {
  const rows: RowDefinition[] = [
    ...
    { name: "Total net Insurance service result from Insurance contracts issued", rowCode: "599", indent: 0, isTotal: true },
    { name: "Total net Insurance service result from Reinsurance contracts issued", rowCode: "699", indent: 0, isTotal: false },
    { name: "TOTAL - NET", rowCode: "899", indent: 0, isTotal: true, isFinalTotal: true }
  ];
