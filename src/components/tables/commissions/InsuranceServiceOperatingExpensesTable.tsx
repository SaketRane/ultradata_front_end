...
const InsuranceServiceOperatingExpensesTable: React.FC = () => {
  const rows: RowDefinition[] = [
    ...
    {
      name: 'Defined Benefit Pension Plan Expense',
      rowCode: '030',
      indent: 0,
      isTotal: false,
    },
    ...
    {
      name: 'Agency (excluding commissions)',
      rowCode: '050',
      indent: 0,
      isTotal: false,
    },
    ...
    {
      name: 'Professional fees (other than legal)',
      rowCode: '070',
      indent: 0,
      isTotal: false,
    },
    ...
    {
      name: 'Contingent Commissions',
      rowCode: '095',
      indent: 0,
      isTotal: false,
    },
    {
      name: 'Losses on onerous insurance contracts',
      rowCode: '100',
      indent: 0,
      isTotal: false,
    },
    ...
    {
      name: 'Impairment of goodwill and intangible assets',
      rowCode: '130',
      indent: 0,
      isTotal: false,
    },
    {
      name: 'Amortization and Impairment loss on Investment/Service Contracts',
      rowCode: '140',
      indent: 0,
      isTotal: false,
    },
    {
      name: 'Occupancy expenses (including rent, leasing and maintenance)',
      rowCode: '150',
      indent: 0,
      isTotal: false,
    },
    ...
    {
      name: 'Inspections and Investigations',
      rowCode: '170',
      indent: 0,
      isTotal: false,
    },
    ...
    {
      name: 'Experience Rating Refunds',
      rowCode: '200',
      indent: 0,
      isTotal: false,
    },
    ...
    {
      name: 'Amounts attributed to insurance acquisition cash flows',
      rowCode: '320',
      indent: 0,
      isTotal: false,
    },
    {
      name: 'Amortization of insurance acquisition cash flows',
      rowCode: '340',
      indent: 0,
      isTotal: false,
    },
    ...
    {
      name: 'General and operating expenses',
      rowCode: '440',
      indent: 0,
      isTotal: false,
    },
  ...
  return <FinancialTable rows={rows} columns={columns} sheetCode="8025" />;
};
