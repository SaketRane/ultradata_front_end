...
/**
 * Reinsurance Held: Coverage vs. Claims Table component
 * Displays detailed breakdown of reinsurance contract held balances by coverage and claims components
 */
const ReinsuranceHeldCoverageVsClaimsTable: React.FC = () => {
  ...
  const rows: RowDefinition[] = useMemo(() => [
    ...
    { name: "Modified Retrospective", rowCode: "105", indent: 3, isTotal: false },
    { name: "Fair value", rowCode: "110", indent: 3, isTotal: false },
    { name: "Other", rowCode: "115", indent: 3, isTotal: false },
    { name: "Allocation of reinsurance premiums paid", rowCode: "119", indent: 2, isTotal: true },
    { name: "Incurred claims recovered and other reinsurance service expenses", rowCode: "130", indent: 3, isTotal: false },
    { name: "Amortization of reinsurance acquisition cash flows", rowCode: "135", indent: 3, isTotal: false },
    { name: "Recovery of losses and reversal on recovery of losses", rowCode: "140", indent: 3, isTotal: false },
    { name: "Adjustments to assets for incurred claims", rowCode: "145", indent: 3, isTotal: false },
    { name: "Amounts recoverable from reinsurers", rowCode: "149", indent: 2, isTotal: true },
    { name: "Investment components", rowCode: "120", indent: 2, isTotal: false },
    { name: "Effect of changes in non-performance risk of reinsurers", rowCode: "160", indent: 2, isTotal: false },
    ...
    { name: "Ending balance reinsurance contract held asssets", rowCode: "459", indent: 1, isTotal: false },
  ...
  const columns: ColumnDefinition[] = useMemo(() => [
    ...
    { id: "currentTotal", label: "TOTAL (Current)", colCode: "19" },
    ...
    { id: "priorRemainingTotal", label: "Total", colCode: "30" },
    ...
    { id: "priorTotal", label: "TOTAL (Prior)", colCode: "39" }
  ], []);

  // Multi-level header for the table showing period and coverage divisions
  const secondaryHeader = useMemo(() => (
    <>
      <TableRow className="h-6">
        ...
        <TableHead className="text-xs font-semibold text-center py-0 px-2"></TableHead>
      </TableRow>
      <TableRow className="h-6">
        <TableHead className="text-xs font-semibold text-left py-0 px-2 border-r"></TableHead>
...
export default React.memo(ReinsuranceHeldCoverageVsClaimsTable);
