...
export const sheet2014Header = [
  { id: "currentPeriod", label: "Current Period", colCode: "header1", colSpan: 8 },
  { id: "priorPeriod", label: "Prior Period Restated", colCode: "header2", colSpan: 4 }
];
