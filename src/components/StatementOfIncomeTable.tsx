...
const statementOfIncomeRows = [
  ...
  {
    name: 'Decrease (increase) in Net Unearned Premiums',
    rowCode: '05',
    indent: 2,
    isTotal: false,
  },
  ...
  {
    name: 'Total Underwriting Revenue',
    rowCode: '09',
    indent: 1,
    isTotal: true,
  },
  {
    name: 'Gross Claims and Adjustment Expenses',
    rowCode: '62',
    indent: 2,
    isTotal: false,
  },
  {
    name: "Reinsurers' share of claims and adjustment expenses",
    rowCode: '64',
    indent: 2,
    isTotal: false,
  },
  {
    name: 'Net Claims and Adjustment Expenses',
    rowCode: '10',
    indent: 1,
    isTotal: true,
  },
  ...
  {
    name: 'Total Claims and Expenses',
    rowCode: '19',
    indent: 1,
    isTotal: true,
  },
  {
    name: 'Premium Deficiency Adjustments',
    rowCode: '20',
    indent: 2,
    isTotal: false,
  },
  {
    name: 'Underwriting Income (Loss)',
    rowCode: '29',
    indent: 1,
    isTotal: true,
  },
  ...
  {
    name: 'Gains (Losses) from FVO or FVTPL',
    rowCode: '35',
    indent: 1,
    isTotal: false,
  },
  ...
  {
    name: "Income (Loss) from Ancillary Operations (net of Expenses of $'000 ...................)",
    rowCode: '40',
    indent: 1,
    isTotal: false,
    hasExpensesCol: true,
  ...
  {
    name: 'Share of Net Income (Loss) of Subsidiaries, Associates & Joint Ventures',
    rowCode: '41',
    indent: 1,
    isTotal: false,
  },
  {
    name: 'Overlay approach adjustment for financial instruments (Reclass from P&L to OCI)',
    rowCode: '48',
    indent: 1,
    isTotal: false,
  },
  {
    name: 'Share of Net Income (Loss) of Pooled Funds using Equity Method',
    rowCode: '47',
    indent: 1,
    isTotal: false,
  },
  {
    name: 'Gains (Losses) from fluctuations in Foreign Exchange Rates',
    rowCode: '42',
    indent: 1,
    isTotal: false,
  },
  ...
  {
    name: 'Net Income (Loss) before Income Taxes',
    rowCode: '49',
    indent: 1,
    isTotal: true,
  },
  ...
  {
    name: 'NET INCOME (LOSS) FOR THE YEAR',
    rowCode: '89',
    indent: 0,
    isTotal: true,
    isFinalTotal: true,
...
const StatementOfIncomeTable: React.FC = () => {
  ...
  useLayoutEffect(() => {
    ...
    statementOfIncomeRows.forEach((row) => {
      columns.forEach((col) => {
        arrayOfCellCode.push(generateCellCode(row.rowCode, col.colCode));
      });
    });
    handleBatchCode(arrayOfCellCode);
  }, [statementOfIncomeRows, columns]);
      ...
      <Table className="min-w-[800px] text-xs">
        ...
        <TableBody className="text-[10px]">
          {statementOfIncomeRows.map((row, index) => {
            ...
            const borderClass = row.isHeader
              ? ''
              : 'border-dotted border-b border-gray-300';
            ...
            return (
              ...
              >
                ...
                {columns.map((col) => {
                  ...
                  const isDisabled =
                    !row.rowCode ||
                    (col.id === 'expenses' && !row.hasExpensesCol);
