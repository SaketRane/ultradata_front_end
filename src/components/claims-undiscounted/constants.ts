...
/**
 * Province and territory code definitions
 */
export const PROVINCE_COLUMNS: ProvinceColumn[] = [
  { name: "NL", code: "01" },
  { name: "PE", code: "02" },
  { name: "NS", code: "03" }, 
  { name: "NB", code: "04" },
...
/**
 * Row definitions for insurance classes
 */
export const TABLE_ROWS: InsuranceRow[] = [
  // Property
