...
const StatementOfProfitOrLossTable: React.FC = () => {
  const rows: RowDefinition[] = [
    { name: "Revenue from PAA Contracts", rowCode: "010", indent: 0, isTotal: false },
    { name: "Revenue from GMM Contracts (excluding VFA contracts)", rowCode: "020", indent: 0, isTotal: false },
    { name: "Revenue from VFA Contracts", rowCode: "030", indent: 0, isTotal: false },
    ...
    { name: "Interest revenue on financial assets not measured at FVTPL", rowCode: "220", indent: 0, isTotal: false },
    { name: "Net investment income excluding segregated funds", rowCode: "230", indent: 0, isTotal: false },
    { name: "Net investment income - segregated funds", rowCode: "240", indent: 0, isTotal: false },
    { name: "Provision for Credit Losses", rowCode: "250", indent: 0, isTotal: false },
    { name: "Investment Return", rowCode: "300", indent: 0, isTotal: true },
    { name: "Net finance income (expenses) from insurance contracts excluding segregated funds", rowCode: "310", indent: 0, isTotal: false },
    { name: "Net finance income (expenses) from segregated funds", rowCode: "315", indent: 0, isTotal: false },
    { name: "Net finance income (expenses) from reinsurance contracts held", rowCode: "320", indent: 0, isTotal: false },
    { name: "Movement in investment contract liabilities", rowCode: "330", indent: 0, isTotal: false },
    { name: "NET INVESTMENT RESULT", rowCode: "399", indent: 0, isTotal: true },
    { name: "", rowCode: "", indent: 0, isHeader: true }, // Empty row for spacing
    { name: "Other Income", rowCode: "410", indent: 0, isTotal: false },
    { name: "Share of Net Income (Loss) of Equity Accounted Investees", rowCode: "415", indent: 0, isTotal: false },
    { name: "General and Operating Expenses", rowCode: "420", indent: 0, isTotal: false },
    ...
    { name: "", rowCode: "", indent: 0, isHeader: true }, // Empty row for spacing
    { name: "Current Taxes", rowCode: "450", indent: 0, isTotal: false },
    { name: "Deferred Taxes", rowCode: "460", indent: 0, isTotal: false },
