...
const LiabilityRollForwardTable: React.FC<LiabilityRollForwardTableProps> = ({ sheetCode }) => {
  ...
  // Secondary header for 2012 and 2014 sheet codes
  ...
  // Third header for 2012 and 2014 sheet codes
  ...
  // Custom columns for 2012 and 2014
  ...
  // Custom header for 2012 and 2014
  const customHeader = useMemo(() => {
    if (sheetCode === "2012" || sheetCode === "2014") {
      return (
        <>
          {secondaryHeader}
          {thirdHeader}
